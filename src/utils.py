...
def get_generator(distribution_name, params):
    ...
    generators = {
        "skewnorm": lambda size: generate_skewnormal(size, 3),
        "student_t": lambda size: generate_student_t(size, 1),
        "weibull_half_lambda": lambda size: generate_weibull_half_lambda(size, 1, 0.5),
        "lognormal_zero_sigma": lambda size: generate_lognormal_zero_sigma(size)
    }
